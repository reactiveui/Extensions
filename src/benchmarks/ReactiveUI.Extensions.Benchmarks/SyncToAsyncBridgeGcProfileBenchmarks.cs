...
/// <summary>
/// GC-verbose hotspot profile for the sync→async bridge (<c>ToObservableAsync</c> in
/// <c>Async/Bridge/ObservableBridgeExtensions.cs</c>). Trace consumable by <c>rxext-allocreport</c>;
/// complements <see cref="BridgeBenchmarks"/>.
/// </summary>
[ShortRunJob]
[MemoryDiagnoser]
[EventPipeProfiler(EventPipeProfile.GcVerbose)]
public class SyncToAsyncBridgeGcProfileBenchmarks : IDisposable
{
