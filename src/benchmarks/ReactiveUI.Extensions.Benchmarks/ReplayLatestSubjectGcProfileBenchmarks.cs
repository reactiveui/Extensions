...
/// <summary>
/// GC-verbose hotspot profile for the broadcast hot path of <see cref="SerialReplayLatestSubjectAsync{T}"/>.
/// Pairs with <see cref="ReplayLatestSubjectBenchmarks"/>; trace consumable by <c>rxext-allocreport</c>.
/// </summary>
[ShortRunJob]
[MemoryDiagnoser]
[EventPipeProfiler(EventPipeProfile.GcVerbose)]
public class ReplayLatestSubjectGcProfileBenchmarks : IDisposable
{
