...
/// <summary>
/// Measures the per-emission cost of <c>Yield</c>, which forces a threadpool hop between
...
public class YieldBenchmarks : IDisposable
{
    ...
    public async Task SetupAsync()
    {
        ...
        _subscription = await _source.Yield()
    ...
    /// <summary>Drives <see cref="EmissionCount"/> values through the Yield pipeline (each yields to the threadpool).</summary>
