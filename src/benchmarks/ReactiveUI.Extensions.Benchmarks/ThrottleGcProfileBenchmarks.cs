...
/// <summary>GC-verbose hotspot profile for <c>Throttle</c> with an immediate-fire <see cref="TimeProvider"/>.</summary>
[ShortRunJob]
[MemoryDiagnoser]
[EventPipeProfiler(EventPipeProfile.GcVerbose)]
public class ThrottleGcProfileBenchmarks : IDisposable
{
    /// <summary>Number of emissions pushed through the pipeline per invocation.</summary>
    private const int EmissionCount = 10_000;

    /// <summary>Debounce window; ignored because the time provider fires synchronously.</summary>
