...
/// <summary>
/// Provides the arity-14 (<c>fourteen</c>-source) <c>CombineLatest</c> extension method
...
public static partial class ObservableAsync
{
    ...
    public static IObservableAsync<TResult> CombineLatest<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult>(
    ...
    /// <summary>
    /// Async observable that combines the latest values from fourteen source sequences using a selector.
    /// </summary>
        ...
        Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TResult> selector) : ObservableAsync<TResult>
    {
        ...
        internal sealed class CombineLatestSubscription : IAsyncDisposable
        {
            ...
            private readonly IAsyncDisposable?[] _subscriptions = new IAsyncDisposable?[14];
            ...
            private bool TryReadValues(out Values values)
            {
                ...
                {
                    values = new(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14);
                    return true;
                }
            ...
            private async ValueTask EmitLatestAsync(CancellationToken cancellationToken)
            {
                ...
                using (await _gate.LockAsync(_disposeCancellationToken).ConfigureAwait(false))
                {
                    ...
                    await _observer.OnNextAsync(
                        _selector(values.V1, values.V2, values.V3, values.V4, values.V5, values.V6, values.V7, values.V8, values.V9, values.V10, values.V11, values.V12, values.V13, values.V14),
