...
public static partial class ObservableAsync
{
    ...
    public static IObservableAsync<TResult> CombineLatest<T1, T2, T3, T4, T5, T6, T7, TResult>(
        ...
        new CombineLatest7ObservableAsync<T1, T2, T3, T4, T5, T6, T7, TResult>(
    ...
    /// <typeparam name="TResult">The projected element type.</typeparam>
    internal sealed class CombineLatest7ObservableAsync<T1, T2, T3, T4, T5, T6, T7, TResult>(
        CombineLatest7ObservableAsync<T1, T2, T3, T4, T5, T6, T7, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, T6, T7, TResult> selector) : ObservableAsync<TResult>
    {
        /// <summary>
        ...
        internal sealed class CombineLatestSubscription : IAsyncDisposable
        {
            ...
            private readonly IAsyncDisposable?[] _subscriptions = new IAsyncDisposable?[7];
            ...
            private bool TryReadValues(out Values values)
            {
                ...
                {
                    values = new(v1, v2, v3, v4, v5, v6, v7);
                    return true;
                }
            ...
            private async ValueTask EmitLatestAsync(CancellationToken cancellationToken)
            {
                ...
                using (await _gate.LockAsync(_disposeCancellationToken).ConfigureAwait(false))
                {
                    ...
                    await _observer.OnNextAsync(_selector(values.V1, values.V2, values.V3, values.V4, values.V5, values.V6, values.V7), _disposeCancellationToken).ConfigureAwait(false);
                }
            }
        }
    }
