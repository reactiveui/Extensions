...
public class ComprehensiveReactiveExtensionsTests
{
    ...
    public async Task SelectAsyncConcurrent_ProcessesConcurrently()
    {
        ...
        using var sub = subject.SelectAsyncConcurrent(async x =>
        {
            await Task.Delay(10);
            return x * 2;
        }).Subscribe(results.Add);
    ...
    public void CombineLatestValuesAreAllFalse_WithMultipleValues_WorksCorrectly()
    {
        ...
        using var sub = ReactiveExtensions.CombineLatestValuesAreAllFalse(subject1, subject2, subject3)
            .Subscribe(results.Add);
    ...
    public void CombineLatestValuesAreAllTrue_WithMultipleValues_WorksCorrectly()
    {
        ...
        using var sub = ReactiveExtensions.CombineLatestValuesAreAllTrue(subject1, subject2, subject3)
            .Subscribe(results.Add);
    ...
    public void GetMax_WithChangingValues_ReturnsMaximum()
    {
        ...
        using var sub = ReactiveExtensions.GetMax(subject1, subject2, subject3)
            .Subscribe(results.Add);
    ...
    public void GetMin_WithChangingValues_ReturnsMinimum()
    {
        ...
        using var sub = ReactiveExtensions.GetMin(subject1, subject2, subject3)
            .Subscribe(results.Add);
